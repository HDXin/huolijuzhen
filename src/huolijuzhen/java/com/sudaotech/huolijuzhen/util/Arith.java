...
public class Arith {
	 ...
	 * @return 两个参数的和
	 */
	public static String add(BigDecimal b1, BigDecimal b2) {
		return String.valueOf(b1.add(b2));
	}
	 ...
	 * @return 两个参数的差
	 */
	public static String sub(BigDecimal b1, BigDecimal b2) {
		return String.valueOf(b1.subtract(b2));
	}
	 ...
	 * @return 两个参数的积
	 */
	public static String mul(BigDecimal b1, BigDecimal b2) {
		return String.valueOf(b1.multiply(b2));
	}
	...
	public static String round(BigDecimal v, int scale) {
		...
		BigDecimal one = new BigDecimal("1");
		return String.valueOf(v.divide(one, scale, BigDecimal.ROUND_HALF_UP));
	}
