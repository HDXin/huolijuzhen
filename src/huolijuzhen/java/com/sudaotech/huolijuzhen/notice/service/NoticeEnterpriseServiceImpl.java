 ...
 *
 */
public class NoticeEnterpriseServiceImpl extends BaseServiceImpl implements NoticeEnterpriseService {

	EasemobRestAPIFactory factory = ClientContext.getInstance(ClientContext.ENTERPRISE_APP).init().getAPIFactory();
