...
@Path("/admin/platform/communityApply")
public class AdminPlatformCommunityApplyResource extends BusinessBaseResource {
    ...
    public Result<String> update(
    	...
    	try{
            ...
            communityApplyService.update(comm);
    		...
    		logger.error("平台审批活动申请单 error:{}",e);
    ...
    public Result<Map<String,Object>> get(@NotNull @PathParam("id") final Long id) {
    	...
    	try{
    		...
    		logger.error("平台获取活动申请单详情 error:{}",e);
    ...
    public Result<Map<String,Object>> find(
		...
		try{
			...
			//查询创建方为平台的
			query.setCreateSide(CreateSide.PLATFORM);
    		//1.按条件查询活动
			...
			logger.error("平台获取活动申请单列表 error:{}",e);
