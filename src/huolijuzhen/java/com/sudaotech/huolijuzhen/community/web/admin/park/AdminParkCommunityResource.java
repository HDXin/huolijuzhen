...
@Path("/admin/park/community")
public class AdminParkCommunityResource extends BusinessBaseResource {
    ...
    public Result<Map<String, Long>> create(@Valid final Community obj) {
    	...
    	try{
        	...
        	temp.setPublicGrade(PublicGrade.PARK);
        	temp.setCreateSide(CreateSide.PARK);
        	temp.setCreateSideId(parkId);
        	//3.获取当前用户所在园区
...
//    		}
    ...
    public Result<Map<String, Object>> find(
    	...
    	try{
        	...
        	Page<Community> page = communityService.find(query,CreateSide.PARK,parkId);
        	//2.封装活动信息
        	Map<String, Object> dataMap = new HashedMap<String, Object>();
