...
@Path("/banner/enterprise/sources")
public class BannerSourcesResource extends BaseResource {
    ...
    public Result<BannerSources> get(@NotNull @PathParam("id") final Long id) {
        BannerSources obj = bannerSourcesService.getById(id, ReqSourceType.APP_ENTERPRISE);
    ...
    public Result<Page<BannerSources>> find(
		...
		Page<BannerSources> page = bannerSourcesService.find(query, ReqSourceType.APP_ENTERPRISE);
