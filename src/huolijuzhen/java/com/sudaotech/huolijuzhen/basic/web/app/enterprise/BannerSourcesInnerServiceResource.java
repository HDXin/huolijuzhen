...
@Path("/banner/enterprise/service/sources")
public class BannerSourcesInnerServiceResource extends BaseResource {
    ...
    public Result<Map<String, Long>> create(@Valid final BannerSources obj) {
    	if(!obj.getReqSourceType().equals(ReqSourceType.APP_ENTERPRISE_SERVER)){
        ...
        result.setLocation(String.format("/banner/enterprise/service/sources/%s", id));
        result.setData(map);
        return result;
    }
    ...
    public Result<String> update(
    	...
    	if(obj.getReqSourceType()!=null && !obj.getReqSourceType().equals(ReqSourceType.APP_ENTERPRISE_SERVER)){
    ...
    public Result<BannerSources> get(@NotNull @PathParam("id") final Long id) {
        BannerSources obj = bannerSourcesService.getById(id, ReqSourceType.APP_ENTERPRISE_SERVER);
    ...
    public Result<Page<BannerSources>> find(
		...
		Page<BannerSources> page = bannerSourcesService.find(query, ReqSourceType.APP_ENTERPRISE_SERVER);
