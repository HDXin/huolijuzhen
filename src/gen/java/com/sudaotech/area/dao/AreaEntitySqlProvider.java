...
import com.sudaotech.area.dao.AreaEntityExample.Criteria;
import com.sudaotech.area.dao.AreaEntityExample.Criterion;
import com.sudaotech.area.dao.AreaEntityExample;
import java.util.List;
import java.util.Map;

public class AreaEntitySqlProvider {

    public String countByExample(AreaEntityExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("area");
    ...
    public String deleteByExample(AreaEntityExample example) {
        BEGIN();
        DELETE_FROM("area");
        applyWhere(example, false);
        return SQL();
    ...
    public String insertSelective(AreaEntity record) {
        BEGIN();
        INSERT_INTO("area");
        ...
        if (record.getAdcode() != null) {
            VALUES("adcode", "#{adcode,jdbcType=VARCHAR}");
        }
    ...
    public String selectByExample(AreaEntityExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("areaId");
        } else {
            SELECT("areaId");
        }
        SELECT("parentId");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        AreaEntity record = (AreaEntity) parameter.get("record");
        AreaEntityExample example = (AreaEntityExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(AreaEntity record) {
        BEGIN();
        UPDATE("area");
    ...
    protected void applyWhere(AreaEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
