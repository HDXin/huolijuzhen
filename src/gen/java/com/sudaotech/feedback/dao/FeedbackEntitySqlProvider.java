...
import com.sudaotech.feedback.dao.FeedbackEntityExample.Criterion;
import com.sudaotech.feedback.dao.FeedbackEntityExample;
import java.util.List;
import java.util.Map;

public class FeedbackEntitySqlProvider {

    public String countByExample(FeedbackEntityExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("feedback");
    ...
    public String deleteByExample(FeedbackEntityExample example) {
        BEGIN();
    ...
    public String insertSelective(FeedbackEntity record) {
        BEGIN();
        INSERT_INTO("feedback");
        
        if (record.getFeedbackId() != null) {
            VALUES("feedbackId", "#{feedbackId,jdbcType=BIGINT}");
        }
        
        if (record.getFeedbackType() != null) {
            VALUES("feedbackType", "#{feedbackType,jdbcType=INTEGER}");
        }
        ...
        if (record.getFeedbackStatus() != null) {
            VALUES("feedbackStatus", "#{feedbackStatus,jdbcType=INTEGER}");
        }
    ...
    public String selectByExampleWithBLOBs(FeedbackEntityExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("feedbackId");
        } else {
            SELECT("feedbackId");
        }
        SELECT("feedbackType");
    ...
    public String selectByExample(FeedbackEntityExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("feedbackId");
        } else {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        FeedbackEntity record = (FeedbackEntity) parameter.get("record");
        FeedbackEntityExample example = (FeedbackEntityExample) parameter.get("example");
        ...
        if (record.getFeedbackType() != null) {
            SET("feedbackType = #{record.feedbackType,jdbcType=INTEGER}");
        }
        ...
        if (record.getFeedbackStatus() != null) {
            SET("feedbackStatus = #{record.feedbackStatus,jdbcType=INTEGER}");
        }
        ...
        if (record.getBody() != null) {
            SET("body = #{record.body,jdbcType=LONGVARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(FeedbackEntity record) {
        BEGIN();
        UPDATE("feedback");
        ...
        if (record.getFeedbackStatus() != null) {
            SET("feedbackStatus = #{feedbackStatus,jdbcType=INTEGER}");
        }
    ...
    protected void applyWhere(FeedbackEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
