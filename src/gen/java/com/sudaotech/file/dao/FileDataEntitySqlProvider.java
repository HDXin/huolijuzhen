...
import com.sudaotech.file.dao.FileDataEntityExample.Criteria;
import com.sudaotech.file.dao.FileDataEntityExample.Criterion;
import com.sudaotech.file.dao.FileDataEntityExample;
import java.util.List;
import java.util.Map;

public class FileDataEntitySqlProvider {

    public String countByExample(FileDataEntityExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("file_data");
    ...
    public String deleteByExample(FileDataEntityExample example) {
        BEGIN();
        DELETE_FROM("file_data");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(FileDataEntity record) {
        BEGIN();
    ...
    public String selectByExample(FileDataEntityExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("fileId");
        } else {
            SELECT("fileId");
        }
        SELECT("fileType");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        FileDataEntity record = (FileDataEntity) parameter.get("record");
        FileDataEntityExample example = (FileDataEntityExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(FileDataEntity record) {
        BEGIN();
        UPDATE("file_data");
    ...
    protected void applyWhere(FileDataEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
