...
import com.sudaotech.comment.dao.CommentEntityExample.Criterion;
import com.sudaotech.comment.dao.CommentEntityExample;
import java.util.List;
import java.util.Map;

public class CommentEntitySqlProvider {

    public String countByExample(CommentEntityExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("comment");
    ...
    public String deleteByExample(CommentEntityExample example) {
        BEGIN();
        DELETE_FROM("comment");
        applyWhere(example, false);
        return SQL();
    ...
    public String insertSelective(CommentEntity record) {
        BEGIN();
        INSERT_INTO("comment");
    ...
    public String selectByExample(CommentEntityExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("commentId");
        } else {
            SELECT("commentId");
        }
        SELECT("type");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CommentEntity record = (CommentEntity) parameter.get("record");
        CommentEntityExample example = (CommentEntityExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(CommentEntity record) {
        BEGIN();
        UPDATE("comment");
    ...
    protected void applyWhere(CommentEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
