...
import com.sudaotech.tag.dao.TagEntityExample.Criterion;
import com.sudaotech.tag.dao.TagEntityExample;
import java.util.List;
import java.util.Map;

public class TagEntitySqlProvider {

    public String countByExample(TagEntityExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("tag");
    ...
    public String deleteByExample(TagEntityExample example) {
        BEGIN();
        DELETE_FROM("tag");
        applyWhere(example, false);
        return SQL();
    ...
    public String insertSelective(TagEntity record) {
        BEGIN();
        INSERT_INTO("tag");
        
        if (record.getTagId() != null) {
            VALUES("tagId", "#{tagId,jdbcType=BIGINT}");
        }
    ...
    public String selectByExample(TagEntityExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TagEntity record = (TagEntity) parameter.get("record");
        TagEntityExample example = (TagEntityExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(TagEntity record) {
        BEGIN();
        UPDATE("tag");
    ...
    protected void applyWhere(TagEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
