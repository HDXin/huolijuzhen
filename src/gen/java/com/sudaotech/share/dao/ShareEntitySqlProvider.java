...
import com.sudaotech.share.dao.ShareEntityExample.Criterion;
import com.sudaotech.share.dao.ShareEntityExample;
import java.util.List;
import java.util.Map;

public class ShareEntitySqlProvider {

    public String countByExample(ShareEntityExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("share");
    ...
    public String deleteByExample(ShareEntityExample example) {
        BEGIN();
        DELETE_FROM("share");
        applyWhere(example, false);
        return SQL();
    ...
    public String insertSelective(ShareEntity record) {
        BEGIN();
        INSERT_INTO("share");
        
        if (record.getShareId() != null) {
            VALUES("shareId", "#{shareId,jdbcType=BIGINT}");
        }
    ...
    public String selectByExample(ShareEntityExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("shareId");
        } else {
            SELECT("shareId");
        }
        SELECT("userId");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ShareEntity record = (ShareEntity) parameter.get("record");
        ShareEntityExample example = (ShareEntityExample) parameter.get("example");
        
        BEGIN();
        UPDATE("share");
        
        if (record.getShareId() != null) {
            SET("shareId = #{record.shareId,jdbcType=BIGINT}");
        }
    ...
    public String updateByPrimaryKeySelective(ShareEntity record) {
        BEGIN();
        UPDATE("share");
    ...
    protected void applyWhere(ShareEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
