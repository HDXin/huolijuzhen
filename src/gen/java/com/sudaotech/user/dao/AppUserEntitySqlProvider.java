...
import com.sudaotech.user.dao.AppUserEntityExample.Criterion;
import com.sudaotech.user.dao.AppUserEntityExample;
import java.util.List;
import java.util.Map;

public class AppUserEntitySqlProvider {

    public String countByExample(AppUserEntityExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("app_user");
    ...
    public String deleteByExample(AppUserEntityExample example) {
        BEGIN();
        DELETE_FROM("app_user");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(AppUserEntity record) {
        BEGIN();
    ...
    public String selectByExample(AppUserEntityExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        AppUserEntity record = (AppUserEntity) parameter.get("record");
        AppUserEntityExample example = (AppUserEntityExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(AppUserEntity record) {
        BEGIN();
        UPDATE("app_user");
    ...
    protected void applyWhere(AppUserEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
