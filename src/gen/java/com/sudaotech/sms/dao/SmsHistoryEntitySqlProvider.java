...
import com.sudaotech.sms.dao.SmsHistoryEntityExample.Criteria;
import com.sudaotech.sms.dao.SmsHistoryEntityExample.Criterion;
import com.sudaotech.sms.dao.SmsHistoryEntityExample;
import java.util.List;
import java.util.Map;

public class SmsHistoryEntitySqlProvider {

    public String countByExample(SmsHistoryEntityExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("sms_history");
    ...
    public String deleteByExample(SmsHistoryEntityExample example) {
        BEGIN();
        DELETE_FROM("sms_history");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(SmsHistoryEntity record) {
        BEGIN();
        INSERT_INTO("sms_history");
        
        if (record.getSmsId() != null) {
            VALUES("smsId", "#{smsId,jdbcType=BIGINT}");
        }
        ...
        if (record.getSmsStatus() != null) {
            VALUES("smsStatus", "#{smsStatus,jdbcType=INTEGER}");
        }
    ...
    public String selectByExample(SmsHistoryEntityExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("smsId");
        } else {
            SELECT("smsId");
        }
        SELECT("phoneNum");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SmsHistoryEntity record = (SmsHistoryEntity) parameter.get("record");
        SmsHistoryEntityExample example = (SmsHistoryEntityExample) parameter.get("example");
        
        BEGIN();
        UPDATE("sms_history");
        
        if (record.getSmsId() != null) {
            SET("smsId = #{record.smsId,jdbcType=BIGINT}");
        }
        
        if (record.getPhoneNum() != null) {
            SET("phoneNum = #{record.phoneNum,jdbcType=VARCHAR}");
        }
        ...
        if (record.getSmsStatus() != null) {
            SET("smsStatus = #{record.smsStatus,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(SmsHistoryEntity record) {
        BEGIN();
        UPDATE("sms_history");
        ...
        if (record.getSmsStatus() != null) {
            SET("smsStatus = #{smsStatus,jdbcType=INTEGER}");
        }
    ...
    protected void applyWhere(SmsHistoryEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
