...
import com.sudaotech.huolijuzhen.bill.dao.CostProEntityExample.Criterion;
import java.util.List;
import java.util.Map;

public class CostProEntitySqlProvider {

    public String countByExample(CostProEntityExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("cost_pro");
    ...
    public String deleteByExample(CostProEntityExample example) {
        BEGIN();
        DELETE_FROM("cost_pro");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(CostProEntity record) {
        BEGIN();
        INSERT_INTO("cost_pro");
        ...
        if (record.getChargeMode() != null) {
            VALUES("chargeMode", "#{chargeMode,jdbcType=INTEGER}");
        }
        
        if (record.getChargePrice() != null) {
            VALUES("chargePrice", "#{chargePrice,jdbcType=DECIMAL}");
        }
        
        if (record.getCostRate() != null) {
            VALUES("costRate", "#{costRate,jdbcType=DECIMAL}");
        }
        ...
        if (record.getIsDefault() != null) {
            VALUES("isDefault", "#{isDefault,jdbcType=INTEGER}");
        }
        ...
        if (record.getRecommendStatus() != null) {
            VALUES("recommendStatus", "#{recommendStatus,jdbcType=INTEGER}");
        }
        
        return SQL();
    }

    public String selectByExample(CostProEntityExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CostProEntity record = (CostProEntity) parameter.get("record");
        CostProEntityExample example = (CostProEntityExample) parameter.get("example");
        ...
        if (record.getChargeMode() != null) {
            SET("chargeMode = #{record.chargeMode,jdbcType=INTEGER}");
        }
        
        if (record.getChargePrice() != null) {
            SET("chargePrice = #{record.chargePrice,jdbcType=DECIMAL}");
        }
        
        if (record.getCostRate() != null) {
            SET("costRate = #{record.costRate,jdbcType=DECIMAL}");
        }
        ...
        if (record.getIsDefault() != null) {
            SET("isDefault = #{record.isDefault,jdbcType=INTEGER}");
        }
        ...
        if (record.getRecommendStatus() != null) {
            SET("recommendStatus = #{record.recommendStatus,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(CostProEntity record) {
        BEGIN();
        UPDATE("cost_pro");
        ...
        if (record.getChargeMode() != null) {
            SET("chargeMode = #{chargeMode,jdbcType=INTEGER}");
        }
        
        if (record.getChargePrice() != null) {
            SET("chargePrice = #{chargePrice,jdbcType=DECIMAL}");
        }
        
        if (record.getCostRate() != null) {
            SET("costRate = #{costRate,jdbcType=DECIMAL}");
        }
        ...
        if (record.getRecommendStatus() != null) {
            SET("recommendStatus = #{recommendStatus,jdbcType=INTEGER}");
        }
    ...
    protected void applyWhere(CostProEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
