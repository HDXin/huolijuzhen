...
public class BillChangeLogsEntity extends BaseEntity {
    private Long id;

    private Long billId;

    private BillOperType operType;
    ...
    public BillOperType getOperType() {
        return operType;
    }

    public void setOperType(BillOperType operType) {
