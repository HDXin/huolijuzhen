...
public class BannerSourcesEntity extends BaseEntity {
    private Long id;

    private String imageUrl;

    private ReqSourceType reqSourceType;
    ...
    public ReqSourceType getReqSourceType() {
        return reqSourceType;
    }

    public void setReqSourceType(ReqSourceType reqSourceType) {
