...
import com.sudaotech.huolijuzhen.sys.common.dao.ImageInfoEntityExample.Criterion;
import java.util.List;
import java.util.Map;

public class ImageInfoEntitySqlProvider {

    public String countByExample(ImageInfoEntityExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("image_info");
    ...
    public String deleteByExample(ImageInfoEntityExample example) {
        BEGIN();
        DELETE_FROM("image_info");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(ImageInfoEntity record) {
        BEGIN();
        INSERT_INTO("image_info");
        ...
        if (record.getImageType() != null) {
            VALUES("imageType", "#{imageType,jdbcType=INTEGER}");
        }
    ...
    public String selectByExample(ImageInfoEntityExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ImageInfoEntity record = (ImageInfoEntity) parameter.get("record");
        ImageInfoEntityExample example = (ImageInfoEntityExample) parameter.get("example");
        ...
        if (record.getImageType() != null) {
            SET("imageType = #{record.imageType,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(ImageInfoEntity record) {
        BEGIN();
        UPDATE("image_info");
    ...
    protected void applyWhere(ImageInfoEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
