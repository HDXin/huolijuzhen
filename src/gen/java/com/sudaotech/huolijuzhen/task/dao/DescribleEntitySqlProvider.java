...
import com.sudaotech.huolijuzhen.task.dao.DescribleEntityExample.Criterion;
import java.util.List;
import java.util.Map;

public class DescribleEntitySqlProvider {

    public String countByExample(DescribleEntityExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("desc_info");
    ...
    public String deleteByExample(DescribleEntityExample example) {
        BEGIN();
        DELETE_FROM("desc_info");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(DescribleEntity record) {
        BEGIN();
        INSERT_INTO("desc_info");
        
        if (record.getId() != null) {
            VALUES("id", "#{id,jdbcType=BIGINT}");
        }
        
        if (record.getDesciption() != null) {
            VALUES("desciption", "#{desciption,jdbcType=VARCHAR}");
        }
    ...
    public String selectByExample(DescribleEntityExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        DescribleEntity record = (DescribleEntity) parameter.get("record");
        DescribleEntityExample example = (DescribleEntityExample) parameter.get("example");
        ...
        if (record.getDesciption() != null) {
            SET("desciption = #{record.desciption,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(DescribleEntity record) {
        BEGIN();
        UPDATE("desc_info");
    ...
    protected void applyWhere(DescribleEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
