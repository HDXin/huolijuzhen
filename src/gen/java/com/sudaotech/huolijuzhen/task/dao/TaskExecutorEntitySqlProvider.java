...
import com.sudaotech.huolijuzhen.task.dao.TaskExecutorEntityExample.Criterion;
import java.util.List;
import java.util.Map;

public class TaskExecutorEntitySqlProvider {

    public String countByExample(TaskExecutorEntityExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("task_executor");
    ...
    public String deleteByExample(TaskExecutorEntityExample example) {
        BEGIN();
        DELETE_FROM("task_executor");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(TaskExecutorEntity record) {
        BEGIN();
        INSERT_INTO("task_executor");
        ...
        if (record.getTaskId() != null) {
            VALUES("taskId", "#{taskId,jdbcType=BIGINT}");
        }
    ...
    public String selectByExample(TaskExecutorEntityExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TaskExecutorEntity record = (TaskExecutorEntity) parameter.get("record");
        TaskExecutorEntityExample example = (TaskExecutorEntityExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(TaskExecutorEntity record) {
        BEGIN();
        UPDATE("task_executor");
    ...
    protected void applyWhere(TaskExecutorEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
