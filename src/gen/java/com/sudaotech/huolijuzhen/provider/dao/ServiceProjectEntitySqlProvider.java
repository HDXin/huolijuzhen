...
import com.sudaotech.huolijuzhen.provider.dao.ServiceProjectEntityExample.Criterion;
import java.util.List;
import java.util.Map;

public class ServiceProjectEntitySqlProvider {

    public String countByExample(ServiceProjectEntityExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("service_pro");
    ...
    public String deleteByExample(ServiceProjectEntityExample example) {
        BEGIN();
        DELETE_FROM("service_pro");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(ServiceProjectEntity record) {
        BEGIN();
        INSERT_INTO("service_pro");
        ...
        if (record.getReleases() != null) {
            VALUES("releases", "#{releases,jdbcType=INTEGER}");
        }
    ...
    public String selectByExampleWithBLOBs(ServiceProjectEntityExample example) {
        BEGIN();
    ...
    public String selectByExample(ServiceProjectEntityExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("id");
        } else {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ServiceProjectEntity record = (ServiceProjectEntity) parameter.get("record");
        ServiceProjectEntityExample example = (ServiceProjectEntityExample) parameter.get("example");
        ...
        if (record.getReleases() != null) {
            SET("releases = #{record.releases,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(ServiceProjectEntity record) {
        BEGIN();
        UPDATE("service_pro");
    ...
    protected void applyWhere(ServiceProjectEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
