...
import com.sudaotech.huolijuzhen.provider.dao.ApplyEntityExample.Criterion;
import java.util.List;
import java.util.Map;

public class ApplyEntitySqlProvider {

    public String countByExample(ApplyEntityExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("apply_info");
    ...
    public String deleteByExample(ApplyEntityExample example) {
        BEGIN();
        DELETE_FROM("apply_info");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(ApplyEntity record) {
        BEGIN();
        INSERT_INTO("apply_info");
        ...
        if (record.getServiceProTitle() != null) {
            VALUES("serviceProTitle", "#{serviceProTitle,jdbcType=VARCHAR}");
        }
        ...
        if (record.getParkName() != null) {
            VALUES("parkName", "#{parkName,jdbcType=VARCHAR}");
        }
    ...
    public String selectByExampleWithBLOBs(ApplyEntityExample example) {
        BEGIN();
    ...
    public String selectByExample(ApplyEntityExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("id");
        } else {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ApplyEntity record = (ApplyEntity) parameter.get("record");
        ApplyEntityExample example = (ApplyEntityExample) parameter.get("example");
        ...
        if (record.getServiceProTitle() != null) {
            SET("serviceProTitle = #{record.serviceProTitle,jdbcType=VARCHAR}");
        }
        ...
        if (record.getParkName() != null) {
            SET("parkName = #{record.parkName,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(ApplyEntity record) {
        BEGIN();
        UPDATE("apply_info");
        ...
        if (record.getServiceProTitle() != null) {
            SET("serviceProTitle = #{serviceProTitle,jdbcType=VARCHAR}");
        }
    ...
    protected void applyWhere(ApplyEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
