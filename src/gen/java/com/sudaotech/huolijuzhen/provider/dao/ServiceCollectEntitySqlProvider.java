...
import com.sudaotech.huolijuzhen.provider.dao.ServiceCollectEntityExample.Criterion;
import java.util.List;
import java.util.Map;

public class ServiceCollectEntitySqlProvider {

    public String countByExample(ServiceCollectEntityExample example) {
        BEGIN();
        SELECT("count(*)");
    ...
    public String deleteByExample(ServiceCollectEntityExample example) {
        BEGIN();
        DELETE_FROM("service_collect");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(ServiceCollectEntity record) {
        BEGIN();
        INSERT_INTO("service_collect");
        ...
        if (record.getCollectBy() != null) {
            VALUES("collectBy", "#{collectBy,jdbcType=BIGINT}");
        }
    ...
    public String selectByExample(ServiceCollectEntityExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ServiceCollectEntity record = (ServiceCollectEntity) parameter.get("record");
        ServiceCollectEntityExample example = (ServiceCollectEntityExample) parameter.get("example");
        ...
        if (record.getCollectBy() != null) {
            SET("collectBy = #{record.collectBy,jdbcType=BIGINT}");
        }
    ...
    public String updateByPrimaryKeySelective(ServiceCollectEntity record) {
        BEGIN();
        UPDATE("service_collect");
        ...
        if (record.getCollectBy() != null) {
            SET("collectBy = #{collectBy,jdbcType=BIGINT}");
        }
    ...
    protected void applyWhere(ServiceCollectEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
