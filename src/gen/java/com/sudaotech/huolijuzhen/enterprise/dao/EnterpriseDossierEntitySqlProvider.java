...
import com.sudaotech.huolijuzhen.enterprise.dao.EnterpriseDossierEntityExample.Criterion;
import com.sudaotech.huolijuzhen.enterprise.dao.EnterpriseDossierEntityExample;
import java.util.List;
import java.util.Map;

public class EnterpriseDossierEntitySqlProvider {

    public String countByExample(EnterpriseDossierEntityExample example) {
        BEGIN();
        SELECT("count(*)");
    ...
    public String deleteByExample(EnterpriseDossierEntityExample example) {
        BEGIN();
        DELETE_FROM("enterprise_dossier");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(EnterpriseDossierEntity record) {
        BEGIN();
        INSERT_INTO("enterprise_dossier");
    ...
    public String selectByExample(EnterpriseDossierEntityExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        EnterpriseDossierEntity record = (EnterpriseDossierEntity) parameter.get("record");
        EnterpriseDossierEntityExample example = (EnterpriseDossierEntityExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(EnterpriseDossierEntity record) {
        BEGIN();
        UPDATE("enterprise_dossier");
    ...
    protected void applyWhere(EnterpriseDossierEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
