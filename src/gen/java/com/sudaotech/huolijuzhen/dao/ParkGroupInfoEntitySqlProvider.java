...
import com.sudaotech.huolijuzhen.dao.ParkGroupInfoEntityExample.Criterion;
import com.sudaotech.huolijuzhen.dao.ParkGroupInfoEntityExample;
import java.util.List;
import java.util.Map;

public class ParkGroupInfoEntitySqlProvider {

    public String countByExample(ParkGroupInfoEntityExample example) {
        BEGIN();
        SELECT("count(*)");
    ...
    public String deleteByExample(ParkGroupInfoEntityExample example) {
        BEGIN();
        DELETE_FROM("park_group_info");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(ParkGroupInfoEntity record) {
        BEGIN();
        INSERT_INTO("park_group_info");
    ...
    public String selectByExample(ParkGroupInfoEntityExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ParkGroupInfoEntity record = (ParkGroupInfoEntity) parameter.get("record");
        ParkGroupInfoEntityExample example = (ParkGroupInfoEntityExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(ParkGroupInfoEntity record) {
        BEGIN();
        UPDATE("park_group_info");
    ...
    protected void applyWhere(ParkGroupInfoEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
