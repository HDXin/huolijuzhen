...
import com.sudaotech.huolijuzhen.dao.ParkGroupUserInfoEntityExample.Criterion;
import com.sudaotech.huolijuzhen.dao.ParkGroupUserInfoEntityExample;
import java.util.List;
import java.util.Map;

public class ParkGroupUserInfoEntitySqlProvider {

    public String countByExample(ParkGroupUserInfoEntityExample example) {
        BEGIN();
        SELECT("count(*)");
    ...
    public String deleteByExample(ParkGroupUserInfoEntityExample example) {
        BEGIN();
        DELETE_FROM("park_group_user_info");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(ParkGroupUserInfoEntity record) {
        BEGIN();
        INSERT_INTO("park_group_user_info");
    ...
    public String selectByExample(ParkGroupUserInfoEntityExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ParkGroupUserInfoEntity record = (ParkGroupUserInfoEntity) parameter.get("record");
        ParkGroupUserInfoEntityExample example = (ParkGroupUserInfoEntityExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(ParkGroupUserInfoEntity record) {
        BEGIN();
        UPDATE("park_group_user_info");
    ...
    protected void applyWhere(ParkGroupUserInfoEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
