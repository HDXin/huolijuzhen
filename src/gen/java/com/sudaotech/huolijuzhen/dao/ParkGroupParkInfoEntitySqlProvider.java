...
import com.sudaotech.huolijuzhen.dao.ParkGroupParkInfoEntityExample.Criterion;
import com.sudaotech.huolijuzhen.dao.ParkGroupParkInfoEntityExample;
import java.util.List;
import java.util.Map;

public class ParkGroupParkInfoEntitySqlProvider {

    public String countByExample(ParkGroupParkInfoEntityExample example) {
        BEGIN();
        SELECT("count(*)");
    ...
    public String deleteByExample(ParkGroupParkInfoEntityExample example) {
        BEGIN();
        DELETE_FROM("park_group_park_info");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(ParkGroupParkInfoEntity record) {
        BEGIN();
        INSERT_INTO("park_group_park_info");
        
        if (record.getId() != null) {
            VALUES("id", "#{id,jdbcType=BIGINT}");
        }
        
        if (record.getParkGroupId() != null) {
            VALUES("parkGroupId", "#{parkGroupId,jdbcType=BIGINT}");
        }
    ...
    public String selectByExample(ParkGroupParkInfoEntityExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ParkGroupParkInfoEntity record = (ParkGroupParkInfoEntity) parameter.get("record");
        ParkGroupParkInfoEntityExample example = (ParkGroupParkInfoEntityExample) parameter.get("example");
        ...
        if (record.getParkGroupId() != null) {
            SET("parkGroupId = #{record.parkGroupId,jdbcType=BIGINT}");
        }
    ...
    public String updateByPrimaryKeySelective(ParkGroupParkInfoEntity record) {
        BEGIN();
        UPDATE("park_group_park_info");
    ...
    protected void applyWhere(ParkGroupParkInfoEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
