...
import com.sudaotech.huolijuzhen.approval.dao.ApprovalTypeEntityExample.Criterion;
import com.sudaotech.huolijuzhen.approval.dao.ApprovalTypeEntityExample;
import java.util.List;
import java.util.Map;

public class ApprovalTypeEntitySqlProvider {

    public String countByExample(ApprovalTypeEntityExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("approval_type");
    ...
    public String deleteByExample(ApprovalTypeEntityExample example) {
        BEGIN();
        DELETE_FROM("approval_type");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(ApprovalTypeEntity record) {
        BEGIN();
        INSERT_INTO("approval_type");
        ...
        if (record.getLatestVersion() != null) {
            VALUES("latestVersion", "#{latestVersion,jdbcType=INTEGER}");
        }
    ...
    public String selectByExample(ApprovalTypeEntityExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ApprovalTypeEntity record = (ApprovalTypeEntity) parameter.get("record");
        ApprovalTypeEntityExample example = (ApprovalTypeEntityExample) parameter.get("example");
        ...
        if (record.getLatestVersion() != null) {
            SET("latestVersion = #{record.latestVersion,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(ApprovalTypeEntity record) {
        BEGIN();
        UPDATE("approval_type");
        ...
        if (record.getLatestVersion() != null) {
            SET("latestVersion = #{latestVersion,jdbcType=INTEGER}");
        }
    ...
    protected void applyWhere(ApprovalTypeEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
