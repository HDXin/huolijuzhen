...
import com.sudaotech.huolijuzhen.approval.dao.ApprovalTypeItemEntityExample.Criterion;
import com.sudaotech.huolijuzhen.approval.dao.ApprovalTypeItemEntityExample;
import java.util.List;
import java.util.Map;

public class ApprovalTypeItemEntitySqlProvider {

    public String countByExample(ApprovalTypeItemEntityExample example) {
        BEGIN();
        SELECT("count(*)");
    ...
    public String deleteByExample(ApprovalTypeItemEntityExample example) {
        BEGIN();
        DELETE_FROM("approval_type_item");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(ApprovalTypeItemEntity record) {
        BEGIN();
        INSERT_INTO("approval_type_item");
        ...
        if (record.getCurrentVersion() != null) {
            VALUES("currentVersion", "#{currentVersion,jdbcType=INTEGER}");
        }
        ...
        if (record.getApprovalNo() != null) {
            VALUES("approvalNo", "#{approvalNo,jdbcType=INTEGER}");
        }
    ...
    public String selectByExample(ApprovalTypeItemEntityExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ApprovalTypeItemEntity record = (ApprovalTypeItemEntity) parameter.get("record");
        ApprovalTypeItemEntityExample example = (ApprovalTypeItemEntityExample) parameter.get("example");
        ...
        if (record.getCurrentVersion() != null) {
            SET("currentVersion = #{record.currentVersion,jdbcType=INTEGER}");
        }
        ...
        if (record.getApprovalNo() != null) {
            SET("approvalNo = #{record.approvalNo,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(ApprovalTypeItemEntity record) {
        BEGIN();
        UPDATE("approval_type_item");
        ...
        if (record.getCurrentVersion() != null) {
            SET("currentVersion = #{currentVersion,jdbcType=INTEGER}");
        }
        ...
        if (record.getApprovalNo() != null) {
            SET("approvalNo = #{approvalNo,jdbcType=INTEGER}");
        }
    ...
    protected void applyWhere(ApprovalTypeItemEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
