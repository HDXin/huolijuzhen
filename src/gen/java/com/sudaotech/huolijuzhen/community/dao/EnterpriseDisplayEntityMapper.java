...
public interface EnterpriseDisplayEntityMapper {
    ...
    @Insert({
        "insert into enterprise_display (id, enterpriseId, ",
        "parkId, info, introduce, ",
        "thumbnailUrl, publishLevel, ",
        "detailUrl, approvalStatus, ",
        "approvalDate, approvalUser, ",
        "version, status, ",
        "createBy, createTime, ",
        "updateBy, updateTime, ",
        "lastUpdate, details)",
        "values (#{id,jdbcType=BIGINT}, #{enterpriseId,jdbcType=BIGINT}, ",
        "#{parkId,jdbcType=BIGINT}, #{info,jdbcType=VARCHAR}, #{introduce,jdbcType=VARCHAR}, ",
        "#{thumbnailUrl,jdbcType=VARCHAR}, #{publishLevel,jdbcType=INTEGER}, ",
        "#{detailUrl,jdbcType=VARCHAR}, #{approvalStatus,jdbcType=INTEGER}, ",
        "#{approvalDate,jdbcType=TIMESTAMP}, #{approvalUser,jdbcType=INTEGER}, ",
        "#{version,jdbcType=INTEGER}, #{status,jdbcType=INTEGER}, ",
        "#{createBy,jdbcType=BIGINT}, #{createTime,jdbcType=TIMESTAMP}, ",
        "#{updateBy,jdbcType=BIGINT}, #{updateTime,jdbcType=TIMESTAMP}, ",
        "#{lastUpdate,jdbcType=TIMESTAMP}, #{details,jdbcType=LONGVARCHAR})"
    })
    ...
    @Select({
        "select",
        "id, enterpriseId, parkId, info, introduce, thumbnailUrl, publishLevel, detailUrl, ",
        "approvalStatus, approvalDate, approvalUser, version, status, createBy, createTime, ",
    ...
    @Update({
        ...
        "set enterpriseId = #{enterpriseId,jdbcType=BIGINT},",
          ...
          "publishLevel = #{publishLevel,jdbcType=INTEGER},",
          ...
          "approvalUser = #{approvalUser,jdbcType=INTEGER},",
