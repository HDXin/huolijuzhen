...
import com.sudaotech.favorite.dao.FavoriteEntityExample.Criteria;
import com.sudaotech.favorite.dao.FavoriteEntityExample.Criterion;
import com.sudaotech.favorite.dao.FavoriteEntityExample;
import java.util.List;
import java.util.Map;

public class FavoriteEntitySqlProvider {

    public String countByExample(FavoriteEntityExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("favorite");
    ...
    public String deleteByExample(FavoriteEntityExample example) {
        BEGIN();
    ...
    public String insertSelective(FavoriteEntity record) {
        BEGIN();
        INSERT_INTO("favorite");
        
        if (record.getFavoriteId() != null) {
            VALUES("favoriteId", "#{favoriteId,jdbcType=BIGINT}");
        }
        ...
        if (record.getTargetId() != null) {
            VALUES("targetId", "#{targetId,jdbcType=BIGINT}");
        }
    ...
    public String selectByExample(FavoriteEntityExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("favoriteId");
        } else {
            SELECT("favoriteId");
        }
        SELECT("userId");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        FavoriteEntity record = (FavoriteEntity) parameter.get("record");
        FavoriteEntityExample example = (FavoriteEntityExample) parameter.get("example");
        
        BEGIN();
        UPDATE("favorite");
        
        if (record.getFavoriteId() != null) {
            SET("favoriteId = #{record.favoriteId,jdbcType=BIGINT}");
        }
        ...
        if (record.getTargetId() != null) {
            SET("targetId = #{record.targetId,jdbcType=BIGINT}");
        }
    ...
    public String updateByPrimaryKeySelective(FavoriteEntity record) {
        BEGIN();
        UPDATE("favorite");
        ...
        if (record.getTargetId() != null) {
            SET("targetId = #{targetId,jdbcType=BIGINT}");
        }
    ...
    protected void applyWhere(FavoriteEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
