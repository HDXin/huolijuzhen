...
import com.sudaotech.node.dao.NodeEntityExample.Criteria;
import com.sudaotech.node.dao.NodeEntityExample.Criterion;
import com.sudaotech.node.dao.NodeEntityExample;
import java.util.List;
import java.util.Map;

public class NodeEntitySqlProvider {

    public String countByExample(NodeEntityExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("node");
    ...
    public String deleteByExample(NodeEntityExample example) {
        BEGIN();
        DELETE_FROM("node");
        applyWhere(example, false);
        return SQL();
    ...
    public String insertSelective(NodeEntity record) {
        BEGIN();
        INSERT_INTO("node");
        
        if (record.getNodeId() != null) {
            VALUES("nodeId", "#{nodeId,jdbcType=BIGINT}");
        }
        
        if (record.getNodeType() != null) {
            VALUES("nodeType", "#{nodeType,jdbcType=INTEGER}");
        }
        ...
        if (record.getAttr() != null) {
            VALUES("attr", "#{attr,jdbcType=CHAR}");
        }
    ...
    public String selectByExample(NodeEntityExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("nodeId");
        } else {
            SELECT("nodeId");
        }
        SELECT("nodeType");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        NodeEntity record = (NodeEntity) parameter.get("record");
        NodeEntityExample example = (NodeEntityExample) parameter.get("example");
        ...
        if (record.getNodeType() != null) {
            SET("nodeType = #{record.nodeType,jdbcType=INTEGER}");
        }
        ...
        if (record.getAttr() != null) {
            SET("attr = #{record.attr,jdbcType=CHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(NodeEntity record) {
        BEGIN();
        UPDATE("node");
    ...
    protected void applyWhere(NodeEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
