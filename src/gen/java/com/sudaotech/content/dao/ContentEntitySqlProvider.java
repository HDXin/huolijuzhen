...
import com.sudaotech.content.dao.ContentEntityExample.Criterion;
import com.sudaotech.content.dao.ContentEntityExample;
import java.util.List;
import java.util.Map;

public class ContentEntitySqlProvider {

    public String countByExample(ContentEntityExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("content");
    ...
    public String deleteByExample(ContentEntityExample example) {
        BEGIN();
        DELETE_FROM("content");
        applyWhere(example, false);
        return SQL();
    ...
    public String insertSelective(ContentEntity record) {
        BEGIN();
        INSERT_INTO("content");
        
        if (record.getContentId() != null) {
            VALUES("contentId", "#{contentId,jdbcType=BIGINT}");
        }
        
        if (record.getContentType() != null) {
            VALUES("contentType", "#{contentType,jdbcType=INTEGER}");
        }
        ...
        if (record.getVideoUrl() != null) {
            VALUES("videoUrl", "#{videoUrl,jdbcType=VARCHAR}");
        }
    ...
    public String selectByExampleWithBLOBs(ContentEntityExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("contentId");
        } else {
            SELECT("contentId");
        }
        SELECT("contentType");
    ...
    public String selectByExample(ContentEntityExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("contentId");
        } else {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ContentEntity record = (ContentEntity) parameter.get("record");
        ContentEntityExample example = (ContentEntityExample) parameter.get("example");
        
        BEGIN();
        UPDATE("content");
        
        if (record.getContentId() != null) {
            SET("contentId = #{record.contentId,jdbcType=BIGINT}");
        }
        
        if (record.getContentType() != null) {
            SET("contentType = #{record.contentType,jdbcType=INTEGER}");
        }
        ...
        if (record.getVideoUrl() != null) {
            SET("videoUrl = #{record.videoUrl,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(ContentEntity record) {
        BEGIN();
        UPDATE("content");
    ...
    protected void applyWhere(ContentEntityExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
